...
function Blogpost() {
    ...
    return (
        <>
            <div className="w-full px-5 lg:px-10 mt-10 flex flex-col items-start    ">
                ...
                <OwlCarousel items={2} className="owl-theme w-full  justify-around flex-col" autoplay={true} loop margin={30} dots="false">
                ...
                <OwlCarousel items={6} className="owl-theme w-full justify-around flex-col" autoplay={true} loop margin={30} dots="false">
                    {location.state.images.map((image, index) => {
                        return <div className='h-max w-full flex flex-col justify-center items-center item'>
                ...
                <div className='hidden md:flex'>
                <OwlCarousel items={4} className="owl-theme w-full flex justify-around flex-col" autoplay={true} loop margin={30} dots="false">
